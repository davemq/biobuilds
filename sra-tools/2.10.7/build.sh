...
ln -s $BUILD_PREFIX/bin/powerpc64le-conda_cos7-linux-gnu-gcc $BUILD_PREFIX/bin/gcc
ln -s $BUILD_PREFIX/bin/powerpc64le-conda_cos7-linux-gnu-c++ $BUILD_PREFIX/bin/g++
ln -s $BUILD_PREFIX/bin/powerpc64le-conda_cos7-linux-gnu-cc $BUILD_PREFIX/bin/cc
ln -s $BUILD_PREFIX/bin/powerpc64le-conda_cos7-linux-gnu-c++ $BUILD_PREFIX/bin/c++
ln -s $BUILD_PREFIX/bin/powerpc64le-conda_cos7-linux-gnu-ar $BUILD_PREFIX/bin/ar
ln -s $BUILD_PREFIX/bin/powerpc64le-conda_cos7-linux-gnu-ld $BUILD_PREFIX/bin/ld
