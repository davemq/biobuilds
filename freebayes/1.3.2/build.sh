...
export LDFLAGS="-L$PREFIX/lib -L\$(LIB_DIR) -DNO_WARN_X86_INTRINSICS -lvcflib -lhts -lpthread -lz -lm -llzma -lbz2"
...
export CXXFLAGS="-O3 -fsigned-char -DNO_WARN_X86_INTRINSICS -D_FILE_OFFSET_BITS=64 -std=c++0x"
export CFLAGS="-O3 -fsigned-char -DNO_WARN_X86_INTRINSICS -D_FILE_OFFSET_BITS=64"
...
# Set exports.
export CFLAGS="-fsigned-char -DNO_WARN_X86_INTRINSICS -I$PREFIX/include"
export C_INCLUDE_PATH=$PREFIX/include
export CPLUS_INCLUDE_PATH=${PREFIX}/include
...
make CPPFLAGS="-I$PREFIX/include" LDFLAGS="-L$PREFIX/lib" \
	CFLAGS="-fsigned-char -DNO_WARN_X86_INTRINSICS -O3 -D_FILE_OFFSET_BITS=64 -fPIC -I$PREFIX/include -L$PREFIX/lib" \
	CXXFLAGS="-O3 -fsigned-char -DNO_WARN_X86_INTRINSICS -D_FILE_OFFSET_BITS=64 -std=c++0x -fPIC -I$PREFIX/include -L$PREFIX/lib"
cd ..
